...
const projects = [
  ...
  {
    name: 'Kiki Garod — Filmmaker Portfolio',
    category: 'Web Development',
    description: 'Award-winning filmmaker portfolio with cinematic gallery, video reels, and inquiry form for international film commissions.',
    tags: ['React', 'TypeScript', 'GSAP', 'Responsive'],
    url: 'https://github.com/jeremygideonbareh/kiki-garod-portfolio',
    icon: Palette,
    accent: '#3B8A88',
    image: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=600&q=85',
    result: 'Showcased at international film festivals',
  },
  {
    name: 'Crumbs Bakery',
    category: 'Web Development',
