...
const projects = [
  ...
  { name: 'Kiki Garod — Filmmaker Portfolio', category: 'Web Development', description: 'Award-winning filmmaker portfolio built with React 19, TypeScript, and GSAP animations — cinematic full-screen video hero, project case study gallery with lightbox, international film festival awards section, integrated Vimeo reels, and commission inquiry form with budget range selector.', tags: ['React', 'TypeScript', 'GSAP', 'Responsive'], url: 'https://github.com/jeremygideonbareh/kiki-garod-portfolio', accent: '#3B8A88', image: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=600&q=85', result: 'Showcased at international film festivals', videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },
